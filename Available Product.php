...
<?php
    $sql= "select a.Productno, a.Productname, r.Category, r.TotalAmount, (a.Quantity - r.Numberofgoods) as
    Available 
    from Addstock a join Report r 
    on
    a.Productno = r.Productno
    where a.Date between '2022/07/01' and '2022/07/29'
    ";
    ...
    if($results){
        while($row=mysqli_fetch_assoc($results)){
            ...
            // , sum(a.Quantity * r.Numberofgoods) as
            // Available from
            // r.Numberofgoods
