...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.min.js" integrity="sha384-kjU+l4N0Yf4ZOJErLsIcvOU2qSb74wXpOhqTvwVx3OElZRweTnQ6d31fXEoRD1Jy" crossorigin="anonymous"></script>
  ...
  <thead>
      <tr>      
      <th scope="col" text-align="center"> Personal Information</th>
      </tr>
...
<?php
    ...
    if($results){
        while($row=mysqli_fetch_assoc($results)){
            ...
            $companyAdd=$row['companyadress'];
            $regg=$row['regno'];
        
            echo '<tr>
            <tr>
            <th scope="col">S/N</th> <th scope="row">'.$id.'</th>
            </tr>
            ...
            <tr>
            <th scope="col">Mobile No</th> <td>'.$mobile.'</td>
            </tr>
            
            <tr>
            <th scope="col">Company name</th> <td>'.$company.'</td>
            </tr>
            
            <tr>
            <th scope="col">Company Address</th> <td>'.$companyAdd.'</td>
            </tr>
           
            <tr>
            <th scope="col">Reg no</th> <td>'.$regg.'</td>      
            </tr>
