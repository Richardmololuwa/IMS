          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="Report.php">Daily</a></li>
...
<?php
    $sql= "select * from Addstock where Category='Confectionaries'";
    ...
    if($results){
        while($row=mysqli_fetch_assoc($results)){
            ...
            <td>
            <button class="btn btn-primary"><a href="Update.php? updateid='.$prono.'" class="text-light"> Update</a>  </button>
            <button class="btn btn-danger"><a href="Delete.php? deleteid='.$prono.'" class="text-light"> Delete</a>  </button>
            </td>
          </tr>';
        }
    }
