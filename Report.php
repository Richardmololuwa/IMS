...
if(isset($_POST['submit'])){
    ...
    $sql="insert into Report(Productno, Productname, Category, Supplier, Numberofgoods, TotalAmount, Date, NameofAdmin )
    values ('$prono','$proname','$category','$supplier','$Quantity','$Amount','$date', '$Admin')";

    $results=mysqli_query($data,$sql);
    if($results){
        // echo"registration sucessful";
        header('location:Available Product.php');
    }
    else{
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.min.js" integrity="sha384-kjU+l4N0Yf4ZOJErLsIcvOU2qSb74wXpOhqTvwVx3OElZRweTnQ6d31fXEoRD1Jy" crossorigin="anonymous"></script>
    ...
    <div class="mb-3">
        ...
        name="proid" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
    <label class="form-label">Number of Goods Soldout.</label>
        <input type="text" class="form-control" id="exampleInputEmail1" placeholder=""
        name="quantity" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
    <label class="form-label">Admin</label>
        <input type="datetime" class="form-control" id="exampleInputEmail1" placeholder=""
        name="admin" aria-describedby="emailHelp">
    </div>
